...
def enemy_attribute_randomizer(editor: PatcherEditor, configuration: dict):
    ...
    Scale_High = configuration["scale_high"]
    Health_Low = configuration["health_low"]
    Health_High = configuration["health_high"]
    Speed_Low = configuration["speed_low"]
    Speed_High = configuration["speed_high"]
    Damage_Low = configuration["damage_low"]
