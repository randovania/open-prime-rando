...
TRANSLATORS: dict[str, TranslatorAssets] = {
    ...
    "crimson_translator": TranslatorAssets(txtr="custom_translator_holo_crimson.TXTR"),
    "obsidian_translator": TranslatorAssets(txtr="custom_translator_holo_obsidian.TXTR"),
    "pearl_translator": TranslatorAssets(txtr="custom_translator_holo_pearl.TXTR"),
}
